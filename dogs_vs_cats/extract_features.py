...
argument_parser.add_argument('-b', '--batch-size', type=int, default=16,
                             help='Batch size of images to be passed through the network.')
argument_parser.add_argument('-s', '--buffer-size', type=int, default=1000, help='Size of feature extraction buffer.')
...
dataset = HDF5DatasetWriter((len(image_paths), 100352), arguments['output'], data_key='features',

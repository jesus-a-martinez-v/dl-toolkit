...
class MxVGGNet(object):
    @staticmethod
    def build(classes):
        data = mx.sym.Variable('data')

        # First block: (CONV => RELU) * 2 => POOL
        ...
        do1 = mx.sym.Dropout(data=pool1, p=0.25, name='do1')

        # Second block: (CONV => RELU) * 2 => POOL
        ...
        do2 = mx.sym.Dropout(data=pool2, p=0.25, name='do2')
        ...
        do3 = mx.sym.Dropout(data=pool3, p=0.25, name='do3')

        # Fourth block: (CONV => RELU) * 3 => POOL
        ...
        do4 = mx.sym.Dropout(data=pool4, p=0.25, name='do4')

        # Fifth block: (CONV => RELU) * 3 => POOL
        ...
        do5 = mx.sym.Dropout(data=pool5, p=0.25, name='do5')

        # Sixth block: FC => RELU Layers
        ...
        do6 = mx.sym.Dropout(data=bn6_1, p=0.5, name='do6')

        # Seventh block: FC => RELU Layers
        ...
        do7 = mx.sym.Dropout(data=bn7_1, p=0.5, name='do7')
